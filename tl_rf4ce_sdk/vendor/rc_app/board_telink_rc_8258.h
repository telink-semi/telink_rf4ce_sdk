 ...
 *
 * @brief   This is the header file for board_telink_rc_8258.h
 *
 * @author	Zigbee GROUP
 * @date    2021
 *
...
#define	APP_GREEN_LED_GPIO           GPIO_PC6
#define APP_RED_LED_GPIO             GPIO_PC7
 ...
 * */
	...
	#define IR_LEARN_PIN_CFG					do											\
												...
												gpio_setup_up_down_resistor(GPIO_IR_LEARN_IN, MAXTRIX_GPIO_PULL_UP);\
												}while(0);
/*

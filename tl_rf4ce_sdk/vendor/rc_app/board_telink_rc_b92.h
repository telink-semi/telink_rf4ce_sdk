...
#define	MAXTRIX_GPIO_PULL_UP        GPIO_PIN_PULLUP_10K
#define	MAXTRIX_GPIO_PULL_DOWN      GPIO_PIN_PULLDOWN_100K
...
#define	PULL_WAKEUP_SRC_PA7		GPIO_PIN_PULLUP_1M  //SWS pull up
...
#define	APP_GREEN_LED_GPIO           GPIO_PC4
#define APP_RED_LED_GPIO             GPIO_PC4

#define	PC4_FUNC				AS_GPIO
#define PC4_INPUT_ENABLE		0
#define PC4_OUTPUT_ENABLE		1
#define PC4_DATA_OUT			GREEN_LED_OFF_LEVEL
...
#define  KB_DRIVE_PINS  {GPIO_PE6, GPIO_PB1, GPIO_PE5, GPIO_PE7, GPIO_PA0}
#define  KB_SCAN_PINS   {GPIO_PD2, GPIO_PA1, GPIO_PB2, GPIO_PA5, GPIO_PA4, GPIO_PA6}
...
#define	KB_MAP_NORMAL	{\
						{VK_TV_POWER,	VK_RECORED,		VK_NONE_KEY,	VK_TV,			VK_NONE_KEY,},	 \
						{VK_VOLUME_DOWN,VK_NUM_2,		VK_VOLUME_UP,	VK_CH_UP,		VK_HOMEKEY,},	 \
						{VK_RIGHTKEY,	VK_NUM_3,		VK_VOLUME_DOWN,	VK_CH_DOWN,		VK_NUM_1,},	 	 \
 ...
 * */
	...
	#define GPIO_IR_OUT            		  		GPIO_PC0
	#define GPIO_IR_CTRL            		 	GPIO_PA2
	#define GPIO_IR_LEARN_IN					GPIO_PA3
	#define IR_PWM_FUNC							PWM0
	#define IR_PWM_PIN_CFG						pwm_set_pin(GPIO_IR_OUT,IR_PWM_FUNC);
	#define IR_CTRL_PIN_CFG						do										\
												{										\
												gpio_function_en(GPIO_IR_CTRL);			\
...
#define APP_AMIC_PIN_CFG_OFF
#define APP_AMIC_PIN_CFG_ON

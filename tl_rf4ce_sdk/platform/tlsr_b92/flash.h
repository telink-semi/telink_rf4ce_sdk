...
_attribute_data_retention_sec_ void flash_read_page(unsigned long addr, unsigned long len, unsigned char *buf);

_attribute_data_retention_sec_ void flash_write_page(unsigned long addr, unsigned long len, unsigned char *buf);

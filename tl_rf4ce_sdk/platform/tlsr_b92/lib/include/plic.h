 ...
 *        -# Register interrupt service routine using the PLIC_ISR_REGISTER macro, for example: PLIC_ISR_REGISTER(stimer_irq_handler, IRQ1_SYSTIMER).
 *          - stimer_irq_handler - stimer interrupt service routine.
 *          - IRQ1_SYSTIMER - stimer interrupt number.
 ...
 *                   }
 *               }
 *               PLIC_ISR_REGISTER(stimer_irq_handler, IRQ1_SYSTIMER)
 *              @endcode
 *
 */
...
#define IRQ1_SYSTIMER               1  /* STIMER_IRQ: system timer interrupt, - stimer_irq_handler */
#define IRQ2_ALG                    2  /* ALGM_IRQ: analog register master interface interrupt, - analog_irq_handler */
#define IRQ3_TIMER1                 3  /* TIMER1_IRQ, - timer1_irq_handler */
#define IRQ4_TIMER0                 4  /* TIMER0_IRQ, - timer0_irq_handler */
#define IRQ5_DMA                    5  /* DMA_IRQ_IRQ, - dma_irq_handler */
#define IRQ6_BMC                    6  /* BMC_IRQ: ahb bus matrix controller interrupt, - bmc_irq_handler */
#define IRQ7_USB_CTRL_EP_SETUP      7  /* USB_SETUP_IRQ: USB setup interrupt, - usb_ctrl_ep_setup_irq_handler */
#define IRQ8_USB_CTRL_EP_DATA       8  /* USB_DATA_IRQ: USB data interrupt, - usb_ctrl_ep_data_irq_handler */
#define IRQ9_USB_CTRL_EP_STATUS     9  /* USB_STATUS_IRQ: USB status interrupt, - usb_ctrl_ep_status_irq_handler */
#define IRQ10_USB_CTRL_EP_SETINF    10 /* USB_SETINF_IRQ: USB set interface interrupt, - usb_ctrl_ep_setinf_irq_handler */
#define IRQ11_USB_ENDPOINT          11 /* USB_EDP_IRQ: USB edp (1-8) interrupt, - usb_endpoint_irq_handler */

#define IRQ14_ZB_BT                 14 /* ZB_BT_IRQ: BR/EDR sub-system interrupt, - rf_bt_irq_handler */
#define IRQ15_ZB_RT                 15 /* ZB_BLE_TL_IRQ: BLE (TL) sub-system interrupt, - rf_irq_handler */
#define IRQ16_PWM                   16 /* PWM_IRQ, - pwm_irq_handler */
#define IRQ17_PKE                   17 /* PKE_IRQ, - pke_irq_handler */
#define IRQ18_UART1                 18 /* UART1_IRQ, - uart1_irq_handler */
#define IRQ19_UART0                 19 /* UART0_IRQ, - uart0_irq_handler */
#define IRQ20_DFIFO                 20 /* DFIFO_IRQ: audio dma fifo interrupt, - audio_irq_handler */
#define IRQ21_I2C                   21 /* I2C_IRQ, - i2c_irq_handler */
#define IRQ22_LSPI                  22 /* LSPI_IRQ, - lspi_irq_handler */
#define IRQ23_GSPI                  23 /* GSPI_IRQ, - gspi_irq_handler */
#define IRQ24_USB_PWDN              24 /* USB_PWDN_IRQ: USB suspend interrupt, - usb_pwdn_irq_handler */
#define IRQ25_GPIO                  25 /* GPIO_IRQ, - gpio_irq_handler */
#define IRQ26_GPIO2RISC0            26 /* GPIO2RISC[0]_IRQ, - gpio_risc0_irq_handler */
#define IRQ27_GPIO2RISC1            27 /* GPIO2RISC[1]_IRQ, - gpio_risc1_irq_handler */
#define IRQ28_SOFT                  28 /* SOFT_IRQ: software interrupt, - soft_irq_handler */
#define IRQ29_MSPI                  29 /* MSPI_IRQ, - mspi_irq_handler */
#define IRQ30_USB_RESET             30 /* USB_RESET_IRQ: USB reset interrupt, - usb_reset_irq_handler */
#define IRQ31_USB_250US             31 /* USB_250US_SOF_IRQ: USB 250us or SOF interrupt, - usb_250us_irq_handler */

#define IRQ33_QDEC                  33 /* QDEC_IRQ, - qdec_irq_handler */
#define IRQ34_GPIO_SRC0             34 /* GPIO_GROUP_IRQ[0], - gpio_src0_irq_handler */
#define IRQ35_GPIO_SRC1             35 /* GPIO_GROUP_IRQ[1], - gpio_src1_irq_handler */
#define IRQ36_GPIO_SRC2             36 /* GPIO_GROUP_IRQ[2], - gpio_src2_irq_handler */
#define IRQ37_GPIO_SRC3             37 /* GPIO_GROUP_IRQ[3], - gpio_src3_irq_handler */
#define IRQ38_GPIO_SRC4             38 /* GPIO_GROUP_IRQ[4], - gpio_src4_irq_handler */
#define IRQ39_GPIO_SRC5             39 /* GPIO_GROUP_IRQ[5], - gpio_src5_irq_handler */
#define IRQ40_GPIO_SRC6             40 /* GPIO_GROUP_IRQ[6], - gpio_src6_irq_handler */
#define IRQ41_GPIO_SRC7             41 /* GPIO_GROUP_IRQ[7], - gpio_src7_irq_handler */

#define IRQ44_PM_WKUP               44 /* PM_WKUP_IRQ: PM wakeup interrupt, - pm_wkup_irq_handler */
#define IRQ45_PM_IRQ                45 /* PM_MIX_IRQ: PM mixed interrupt, - pm_irq_handler */
#define IRQ46_DPR_IRQ               46 /* DPR_IRQ: dynamic power reduction, - dpr_irq_handler */
/**
 * @}
 */
 ...
 *          - 0 indicates failure to clear all PLIC interrupt requests.
 * @note 

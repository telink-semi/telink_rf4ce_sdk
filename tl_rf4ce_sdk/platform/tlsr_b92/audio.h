...
void audio_i2c_init( gpio_func_pin_e sda_pin,gpio_func_pin_e scl_pin,unsigned char clock);
  ...
  */
_attribute_ram_code_sec_noinline_ void audio_power_down(void);
  ...
  * @return    none
  */
 _attribute_ram_code_sec_ void audio_codec_adc_power_down(void);
  ...
  * @return    none
  */
 _attribute_ram_code_sec_ void audio_codec_dac_power_down(void);
 ...
 * @return    none
 */
_attribute_ram_code_sec_ void audio_codec_set_micbias(power_switch_e en ,micbias_work_mode_e  micbias_mode);

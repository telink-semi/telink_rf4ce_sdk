...
#define reg_gpio_irq_en0(i)		REG_ADDR8(0x587+((i>>8)<<3))	// Ӧreg_irq_mask,reg_irq_src еFLD_IRQ_GPIO_EN
#define reg_gpio_irq_en(i)		REG_ADDR8(0x5c8+(i>>8))			// Ӧreg_irq_mask,reg_irq_src еFLD_IRQ_GPIO_RISC2_EN, Ϊ5320,5328һ, ʹ FLD_IRQ_GPIO_RISC2_EN

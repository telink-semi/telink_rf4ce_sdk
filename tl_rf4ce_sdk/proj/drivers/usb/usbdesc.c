 ...
 * @file    usbdesc.c
 *
 * @brief   This is the source file for usbdesc.c
 *
 * @author	Zigbee GROUP
 * @date    2021
 *
...
const USB_DescriptorString_t language_desc = { {
		sizeof(USB_Descriptor_Header_t) + 2, DTYPE_String },
		{ LANGUAGE_ID_ENG } };


const USB_DescriptorString_t vendor_desc = { { sizeof(USB_Descriptor_Header_t)
		+ sizeof(STRING_VENDOR) - 2, DTYPE_String }, // Header
		STRING_VENDOR };


const USB_DescriptorString_t product_desc = { {
		sizeof(USB_Descriptor_Header_t) + sizeof(STRING_PRODUCT) - 2,
		DTYPE_String }, // Header
		STRING_PRODUCT };

const USB_DescriptorString_t serial_desc = { { sizeof(USB_Descriptor_Header_t)
...
#if (USB_CDC_ENABLE)
#if 1
	0xEF,//USB_CSCP_NoDeviceClass,//USB_CSCP_NoDeviceClass, // Class
        0x02, //0x00, //USB_CSCP_NoDeviceSubclass, // SubClass
        0x01,//0x00,//USB_CSCP_NoDeviceProtocol, // Protocol
#else
...
const USB_Descriptor_Configuration_t
		configuration_desc = { { {
...
#if 1
                {
					...
					AUDIO_CSCP_ControlSubclass, //CDC_CSCP_ACMSubclass, // Subclass
					AUDIO_CSCP_ControlProtocol, //CDC_CSCP_ATCommandProtocol, // protocol
					NO_DESCRIPTOR  // IADStrIndex
				},
#endif
...
//		NO_DESCRIPTOR
//	},
//	// MASS_STORAGE_InEndpoint =
//	{
//		{ sizeof(USB_Descriptor_Endpoint_t), DTYPE_Endpoint },
//		(ENDPOINT_DIR_IN|MASS_STORAGE_IN_EPNUM),
//		EP_TYPE_BULK,
//		MASS_STORAGE_TXRX_EPSIZE,
//		0// PollingIntervalMS
//	},
//	//MASS_STORAGE_OutEndpoint =
//	{
//		{ sizeof(USB_Descriptor_Endpoint_t), DTYPE_Endpoint },
//		ENDPOINT_DIR_OUT|MASS_STORAGE_OUT_EPNUM,
//		EP_TYPE_BULK,
//		MASS_STORAGE_TXRX_EPSIZE,
//		0// PollingIntervalMS
//	},

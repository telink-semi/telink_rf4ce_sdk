...
#endif
#endif
const u8 MSO_APP_VENDOR_STRING[] = {'T', 'L', 0, 0, 0, 0, 0}; //{'T', 'L', 0x20, 0x20, 0x20};  //{'U', 'E', 'I', 0x20, 0x20}; //{'U', 'E', 'I', 0x20, 0x20};//{'T', 'E', 'L', 'I', 'N', 'K', 0x20};
const u8 MSO_APP_USER_STRING[] =   {'S', 'R', '-', '0', '0', '1', '-', 'U', 0, 0,0,0,0,0,0}; // {'H', 'D', 'u', 'D', 'T', 'A', 0, 0, 0, 0, 0}; //"SR-002-U";//{'T', 'E', 'L', 'I', 'N', 'K', 0, 0, 0};//{'G', 'P', 'R', 'E', 'F', 0, 0, '9', 0};//{'T', 'e', 'l', 'i', 'n', 'k', 0, 0, 0};

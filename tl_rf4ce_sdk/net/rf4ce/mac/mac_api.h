 ...
 * @file    mac_api.h
 *
 * @brief   This is the header file for mac_api.h
 *
 * @author	Zigbee GROUP
 * @date    2021
 *
...
/** @addtogroup mac_disasso_reason MAC Disassociation Reason Type
 * Disassociate Reason
 * @{
 */
...
/** @} end of group mac_disasso_reason */
...
void mac_reset(u8 fSetDfltPib);
  ...
  *
  * @param[in]   cbFunc - Specified MAC layer callback function
  *
  * @return      None
  */
void mac_init();

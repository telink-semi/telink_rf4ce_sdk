 ...
 * @{
 */
#define MAC_CHAN_11_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_11)
#define MAC_CHAN_12_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_12)
#define MAC_CHAN_13_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_13)
#define MAC_CHAN_14_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_14)
#define MAC_CHAN_15_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_15)
#define MAC_CHAN_16_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_16)
#define MAC_CHAN_17_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_17)
#define MAC_CHAN_18_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_18)
#define MAC_CHAN_19_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_19)
#define MAC_CHAN_20_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_20)
#define MAC_CHAN_21_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_21)
#define MAC_CHAN_22_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_22)
#define MAC_CHAN_23_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_23)
#define MAC_CHAN_24_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_24)
#define MAC_CHAN_25_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_25)
#define MAC_CHAN_26_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_26)
#define MAC_CHAN_27_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_27)
#define MAC_CHAN_28_MASK            MAC_CHAN_BIT_MASK(MAC_CHAN_28)
 ...
 */
#define MAC_MAX_FRAME_SIZE          0x74
